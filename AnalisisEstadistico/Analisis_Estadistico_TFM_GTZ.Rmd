...
#Analisis estadístico del estudio evolutivo de genes dimórficos, específicos de micelio y de levadura.
...
#Análisis del contenido GC de las Regiones Intergénicas de genes H2H dimórficos.
...
#Análisis estadístico de las diferencias en las longitudes de las Regiones Intergénicas de genes H2H dimórficos:
...
#Analisis estádistico del contenido GC de los genes H2H de todos los hongos de este estudio.
...
#Analisis estádistico de las longitudes de las regiones intergénicas de los genes H2H de todos los hongos de este estudio.
...
print(dunn_res)
```
#Análisis estadístico para determinar las diferencias entre el contenido de islas CpG de los promotores bidereccionales de genes H2H y de genes no son H2H.
